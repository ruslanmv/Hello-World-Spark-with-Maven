...
SPARK_HOME=/home/${USER}/spark-3.3.1-bin-hadoop3

# JAR containing a simple hello world
JARFILE=`pwd`/target/project-1.0.jar

# Run it locally
${SPARK_HOME}/bin/spark-submit --class com.company.HelloWorld --master local $JARFILE